...
title: 论文（或技术文档）修改助手
date: 2026-05-22
description: 一个用于降ai率的Prompt
---
## 使用方法
>使用AI网页版就行。我使用的是Gemini。
>每次新对话开始降AI时复制下面的提示词。
>每降一章或者7-8轮对话就新开一个对话框。

## 如何使用
可以使用Gemini的笔记本功能，把你的AIGC检测报告和论文稿上传。然后再开新对话使用下面的提示词进行降重。
## 提示词（Prompt）
```
你的角色与目标：
...
原文章链接[分享一个论文降ai率的prompt，实测维普6%](https://linux.do/t/topic/620470?u=honestman)